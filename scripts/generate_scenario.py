...
NUM_CHARACTERS = 9  # Caesar + Calpurnia + 4 courtiers + 3 family heads
...
def generate_preamble(
    ...
    lines.append('      <FAMILY_JULIUS>6</FAMILY_JULIUS>')
    lines.append('      <FAMILY_FABIUS>7</FAMILY_FABIUS>')
    lines.append('      <FAMILY_CLAUDIUS>8</FAMILY_CLAUDIUS>')
    lines.append('    </FamilyHeadID>')
    ...
    # Labienus — Senior legate, Tactician
    lines.append('  <Character')
    lines.append('    ID="2"')
    lines.append('    BirthTurn="-40"')
    lines.append('    Player="0"')
    lines.append('    Character="CHARACTER_LABIENUS"')
    lines.append('    Gender="GENDER_MALE"')
    lines.append('    FirstName="NAME_TITUS_LABIENUS"')
    lines.append('    Seed="58100000000000003">')
    lines.append('    <Portrait>CHARACTER_PORTRAIT_ROME_LEADER_MALE_10</Portrait>')
    lines.append('    <NameType>NAME_TITUS_LABIENUS</NameType>')
    lines.append('    <Level>1</Level>')
    lines.append('    <Courtier>COURTIER_SOLDIER</Courtier>')
    lines.append('    <Nation>NATION_ROME</Nation>')
    lines.append('    <Family>FAMILY_JULIUS</Family>')
    lines.append('    <Rating>')
    lines.append('      <RATING_WISDOM>2</RATING_WISDOM>')
    lines.append('      <RATING_CHARISMA>1</RATING_CHARISMA>')
    lines.append('      <RATING_COURAGE>3</RATING_COURAGE>')
    lines.append('      <RATING_DISCIPLINE>3</RATING_DISCIPLINE>')
    lines.append('    </Rating>')
    lines.append('    <Stat />')
    lines.append('    <Trait>')
    lines.append('      <TRAIT_TACTICIAN_ARCHETYPE />')
    lines.append('    </Trait>')
    lines.append('  </Character>')

    # Publius Crassus — Cavalry commander, Hero
    lines.append('  <Character')
    lines.append('    ID="3"')
    lines.append('    BirthTurn="-26"')
    lines.append('    Player="0"')
    lines.append('    Character="CHARACTER_PUBLIUS_CRASSUS"')
    lines.append('    Gender="GENDER_MALE"')
    lines.append('    FirstName="NAME_PUBLIUS_CRASSUS"')
    lines.append('    Seed="58100000000000004">')
    lines.append('    <Portrait>CHARACTER_PORTRAIT_ROME_LEADER_MALE_03</Portrait>')
    lines.append('    <NameType>NAME_PUBLIUS_CRASSUS</NameType>')
    lines.append('    <Level>1</Level>')
    lines.append('    <Courtier>COURTIER_SOLDIER</Courtier>')
    lines.append('    <Nation>NATION_ROME</Nation>')
    lines.append('    <Family>FAMILY_JULIUS</Family>')
    lines.append('    <Rating>')
    lines.append('      <RATING_WISDOM>0</RATING_WISDOM>')
    lines.append('      <RATING_CHARISMA>2</RATING_CHARISMA>')
    lines.append('      <RATING_COURAGE>3</RATING_COURAGE>')
    lines.append('      <RATING_DISCIPLINE>1</RATING_DISCIPLINE>')
    lines.append('    </Rating>')
    lines.append('    <Stat />')
    lines.append('    <Trait>')
    lines.append('      <TRAIT_HERO_ARCHETYPE />')
    lines.append('    </Trait>')
    lines.append('  </Character>')

    # Diviciacus — Aeduan druid/diplomat
    lines.append('  <Character')
    lines.append('    ID="4"')
    lines.append('    BirthTurn="-50"')
    lines.append('    Player="0"')
    lines.append('    Character="CHARACTER_DIVICIACUS"')
    lines.append('    Gender="GENDER_MALE"')
    lines.append('    FirstName="NAME_DIVICIACUS"')
    lines.append('    Seed="58100000000000005">')
    lines.append('    <Portrait>CHARACTER_PORTRAIT_GAUL_MALE_01</Portrait>')
    lines.append('    <NameType>NAME_DIVICIACUS</NameType>')
    lines.append('    <Level>1</Level>')
    lines.append('    <Courtier>COURTIER_MINISTER</Courtier>')
    lines.append('    <Nation>NATION_ROME</Nation>')
    lines.append('    <Rating>')
    lines.append('      <RATING_WISDOM>3</RATING_WISDOM>')
    lines.append('      <RATING_CHARISMA>3</RATING_CHARISMA>')
    lines.append('      <RATING_COURAGE>0</RATING_COURAGE>')
    lines.append('      <RATING_DISCIPLINE>1</RATING_DISCIPLINE>')
    lines.append('    </Rating>')
    lines.append('    <Stat />')
    lines.append('    <Trait>')
    lines.append('      <TRAIT_DIPLOMAT_ARCHETYPE />')
    lines.append('    </Trait>')
    lines.append('  </Character>')

    # Liscus — Aeduan magistrate (vergobret)
    lines.append('  <Character')
    lines.append('    ID="5"')
    lines.append('    BirthTurn="-45"')
    lines.append('    Player="0"')
    lines.append('    Character="CHARACTER_LISCUS"')
    lines.append('    Gender="GENDER_MALE"')
    lines.append('    FirstName="NAME_LISCUS"')
    lines.append('    Seed="58100000000000006">')
    lines.append('    <Portrait>CHARACTER_PORTRAIT_GAUL_MALE_06</Portrait>')
    lines.append('    <NameType>NAME_LISCUS</NameType>')
    lines.append('    <Level>1</Level>')
    lines.append('    <Courtier>COURTIER_MINISTER</Courtier>')
    lines.append('    <Nation>NATION_ROME</Nation>')
    lines.append('    <Rating>')
    ...
    # Aurelia Cotta — Caesar's mother, Julius family head
    lines.append('  <Character')
    lines.append('    ID="6"')
    lines.append('    BirthTurn="-62"')
    lines.append('    Player="0"')
    lines.append('    Character="CHARACTER_AURELIA_COTTA"')
    lines.append('    Gender="GENDER_FEMALE"')
    lines.append('    FirstName="NAME_AURELIA_COTTA"')
    lines.append('    Seed="58100000000000007">')
    lines.append('    <Portrait>CHARACTER_PORTRAIT_ROME_LEADER_FEMALE_07</Portrait>')
    lines.append('    <NameType>NAME_AURELIA_COTTA</NameType>')
    lines.append('    <Level>1</Level>')
    lines.append('    <Nation>NATION_ROME</Nation>')
    lines.append('    <Family>FAMILY_JULIUS</Family>')
    lines.append('    <Rating>')
    ...
    lines.append('    <Trait>')
    lines.append('      <TRAIT_JUDGE_ARCHETYPE />')
    lines.append('      <TRAIT_IN_ROME />')
    lines.append('    </Trait>')
    lines.append('  </Character>')

    # Quintus Fabius Maximus — Fabius family head
    lines.append('  <Character')
    lines.append('    ID="7"')
    lines.append('    BirthTurn="-35"')
    lines.append('    Player="0"')
    lines.append('    Character="CHARACTER_QUINTUS_FABIUS_MAXIMUS"')
    lines.append('    Gender="GENDER_MALE"')
    lines.append('    FirstName="NAME_QUINTUS_FABIUS_MAXIMUS"')
    lines.append('    Seed="58100000000000008">')
    lines.append('    <Portrait>CHARACTER_PORTRAIT_ROME_LEADER_MALE_07</Portrait>')
    lines.append('    <NameType>NAME_QUINTUS_FABIUS_MAXIMUS</NameType>')
    lines.append('    <Level>1</Level>')
    lines.append('    <Nation>NATION_ROME</Nation>')
    lines.append('    <Family>FAMILY_FABIUS</Family>')
    lines.append('    <Rating>')
    lines.append('      <RATING_WISDOM>1</RATING_WISDOM>')
    lines.append('      <RATING_CHARISMA>3</RATING_CHARISMA>')
    lines.append('      <RATING_COURAGE>1</RATING_COURAGE>')
    lines.append('      <RATING_DISCIPLINE>1</RATING_DISCIPLINE>')
    lines.append('    </Rating>')
    lines.append('    <Stat />')
    lines.append('    <Trait>')
    lines.append('      <TRAIT_ORATOR_ARCHETYPE />')
    lines.append('      <TRAIT_IN_ROME />')
    lines.append('    </Trait>')
    lines.append('  </Character>')

    # Appius Claudius Pulcher — Claudius family head
    lines.append('  <Character')
    lines.append('    ID="8"')
    lines.append('    BirthTurn="-39"')
    lines.append('    Player="0"')
    lines.append('    Character="CHARACTER_APPIUS_CLAUDIUS_PULCHER"')
    lines.append('    Gender="GENDER_MALE"')
    lines.append('    FirstName="NAME_APPIUS_CLAUDIUS_PULCHER"')
    lines.append('    Seed="58100000000000009">')
    lines.append('    <Portrait>CHARACTER_PORTRAIT_ROME_LEADER_MALE_12</Portrait>')
    lines.append('    <NameType>NAME_APPIUS_CLAUDIUS_PULCHER</NameType>')
    lines.append('    <Level>1</Level>')
    lines.append('    <Nation>NATION_ROME</Nation>')
    lines.append('    <Family>FAMILY_CLAUDIUS</Family>')
    lines.append('    <Rating>')
    lines.append('      <RATING_WISDOM>3</RATING_WISDOM>')
    lines.append('      <RATING_CHARISMA>2</RATING_CHARISMA>')
    lines.append('      <RATING_COURAGE>0</RATING_COURAGE>')
    ...
    lines.append('    <Stat />')
    lines.append('    <Trait>')
    lines.append('      <TRAIT_SCHOLAR_ARCHETYPE />')
    lines.append('      <TRAIT_IN_ROME />')
    lines.append('    </Trait>')
    lines.append('  </Character>')
...
def write_unit(unit_id: int, unit_type: str) -> list[str]:
    ...
    # Warlords and slingers have no family; all other Roman units are Julius
    if "NOMAD_WARLORD" in unit_type or "BALEARIC_SLINGER" in unit_type:
        family = "NONE"
    else:
        family = "FAMILY_JULIUS"
    lines: list[str] = []
    lines.append(f'    <Unit')
...
def write_xml(
    ...
    print(f"  Characters: {NUM_CHARACTERS} (Caesar, Calpurnia + 4 courtiers + 3 family heads)")
